...
onAuthenticate:_react.PropTypes.func};
...
onAuthenticate:function onAuthenticate(){}};var 
...
if(user)_this2.props.onAuthenticate(JSON.parse(user));});}},{key:'handleOnAuthenticate',value:function handleOnAuthenticate(
...
this.props.onAuthenticate(user);}},{key:'render',value:function render()


{var _this3=this;
// If we are waiting for the token from async storage show a loading screen
if(this.state.loading){
return _react2.default.createElement(_Splash.Splash,{__source:{fileName:_jsxFileName,lineNumber:58}});}
...
_reactNative.StyleSheet.create(this.props.styles.container)],__source:{fileName:_jsxFileName,lineNumber:68}},


_react2.default.createElement(_reactNative.View,{style:_Styles.Styles.logoContainer,__source:{fileName:_jsxFileName,lineNumber:74}},
_react2.default.createElement(_reactNative.View,{style:_Styles.Styles.logoWrap,__source:{fileName:_jsxFileName,lineNumber:75}},
_react2.default.createElement(_reactNative.Text,{style:[_Styles.Styles.logoText,_reactNative.StyleSheet.create(this.props.styles.logoText)],__source:{fileName:_jsxFileName,lineNumber:76}},
this.props.logoText))),



_react2.default.createElement(_reactNative.View,{style:_Styles.Styles.formContainer,__source:{fileName:_jsxFileName,lineNumber:81}},
...
apiEndpoint:_this3.props.registerEndpoint}}));},__source:{fileName:_jsxFileName,lineNumber:82}}),
...
apiEndpoint:_this3.props.authenticateEndpoint}});},__source:{fileName:_jsxFileName,lineNumber:96}}))));}}]);return Authenticator;}(_react2.default.Component);
