...
{var _this3=this;
return (
_react2.default.createElement(_reactNative.View,{style:_Styles.Styles.loginContainer,__source:{fileName:_jsxFileName,lineNumber:74}},
_react2.default.createElement(_reactNative.View,{style:_Styles.Styles.loginLogoContainer,__source:{fileName:_jsxFileName,lineNumber:75}},
_react2.default.createElement(_reactNative.View,{style:{flex:1,justifyContent:'center',alignItems:'center'},__source:{fileName:_jsxFileName,lineNumber:76}},
_react2.default.createElement(_reactNative.Text,{style:{color:'black',fontWeight:'bold'},__source:{fileName:_jsxFileName,lineNumber:77}},'LOGO'))),


_react2.default.createElement(_reactNative.View,{style:_Styles.Styles.formErrorContainer,__source:{fileName:_jsxFileName,lineNumber:80}},
_react2.default.createElement(_reactNative.Text,{style:_Styles.Styles.formError,__source:{fileName:_jsxFileName,lineNumber:81}},
this.state.error?this.state.error:null)),

_react2.default.createElement(_reactNative.View,{style:_Styles.Styles.loginFormContainer,__source:{fileName:_jsxFileName,lineNumber:84}},
_react2.default.createElement(_reactNative.TextInput,{
onChangeText:function onChangeText(text){return _this3.handleFieldChange('name',text);},
value:this.state.name,
placeholder:'Enter your name',__source:{fileName:_jsxFileName,lineNumber:85}}),

_react2.default.createElement(_reactNative.TextInput,{
keyboardType:'email-address',
onChangeText:function onChangeText(text){return _this3.handleFieldChange('email',text);},
value:this.state.email,
placeholder:'Enter your email address',__source:{fileName:_jsxFileName,lineNumber:90}}),

_react2.default.createElement(_reactNative.TextInput,{
secureTextEntry:true,
onChangeText:function onChangeText(text){return _this3.handleFieldChange('password',text);},
value:this.state.password,
placeholder:'Enter your password',__source:{fileName:_jsxFileName,lineNumber:96}}),
...
loadingText:'Creating your account...',__source:{fileName:_jsxFileName,lineNumber:102}}))));}}]);return Register;}(_react2.default.Component);
